...
| [`SmartAdminLibrary`](https://github.com/zoujingli/SmartAdminLibrary) | Public | `zoujingli/smart_admin_library` 基础库 Composer 包，承载 Core、权限、数据范围、租户、日志、发布和源码插件管理能力 |
| [`SmartAdmin`](https://github.com/zoujingli/SmartAdmin) | Public | `zoujingli/smart_admin` 开源主项目，只包含通用后台核心、开源插件、Web 通用壳、文档和测试 |
