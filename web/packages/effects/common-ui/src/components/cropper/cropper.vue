...
.cropper-view {
  @apply absolute bottom-0 left-0 right-0 top-0 select-none outline outline-1;
  outline-color: var(--ant-color-primary, #1677ff);
}
...
.cropper-line-s {
  ...
  background-color: var(--ant-color-primary-bg, rgb(22 119 255 / 0.12));
}
...
/* 拖拽点 */
.cropper-point {
  @apply absolute flex h-2 w-2 items-center justify-center;
