...
const columns = [
  ...
  { title: '导航位置', dataIndex: 'position', width: 110 },
  { title: '链接类型', dataIndex: 'link_type', width: 120 },
...
const fields: any[] = [
  ...
  { label: '父级导航', name: 'parent_id', type: 'select', optionApi: 'system/website/nav/options', defaultValue: 0, emptyValue: 0 },
  ...
  { label: '关联栏目', name: 'channel_id', type: 'select', optionApi: 'system/website/channel/options', defaultValue: 0, emptyValue: 0 },
  { label: '关联内容', name: 'content_id', type: 'select', optionApi: 'system/website/content/options', defaultValue: 0, emptyValue: 0 },
