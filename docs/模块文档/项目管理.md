...
Bug 管理列表的“搜索内容”支持标题、描述、复测/关闭说明模糊查询，也支持按 Bug 编码精确查询；`B104`、`#B104`、`b104`、`#b104`、`104` 都表示查询 ID 为 104 的 Bug。编码查询和文本模糊查询必须在同一组条件中追加，不能因为 `OR` 条件放宽产品、版本、任务、测试、子任务、状态或人员筛选。
