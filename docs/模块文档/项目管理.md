...
| 子任务验收 | 测试 | `project_task_subtask.accept_account_id` | `project.subtask.accept` | 是 | 我的工作、关键钉钉待办 |
...
| 采购执行 | 采购 | `project_product.purchase_account_id` | `project.product.purchase-start`、`project.product.bom-draft`、`project.product.purchase-confirm` | 否 | 我的工作 |
